...
public class MeshParticle extends Mesh {
    public MeshParticle(float[] matrixWorld, FloatBuffer positionBuffer, FloatBuffer velocityBuffer, float[] acceleration, float[] time, float[] color, int primitiveCount, int primitiveType) {
